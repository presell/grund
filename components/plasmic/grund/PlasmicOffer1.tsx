...
import sty from "./PlasmicOffer1.module.css"; // plasmic-import: ZWHOp2fm9glm/css
...
function PlasmicOffer1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__cd637)}>
        <div className={classNames(projectcss.all, sty.freeBox__nnes4)}>
          {renderPlasmicSlot({
            defaultContents: (
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__iFZh8)}
                displayHeight={"423px"}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__kiNxp)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__hjio)}>
          {renderPlasmicSlot({
            defaultContents:
        ...
        <div className={classNames(projectcss.all, sty.freeBox__jZcSi)}>
          {renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ptpaU)}>
          <div className={classNames(projectcss.all, sty.freeBox__pHRp1)}>
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__m6IO)}
                    displayHeight={"60px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__vJ0Pt)}>
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__lnbp2)}
                    displayHeight={"60px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicOffer1__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicOffer1__ArgsType, ReservedPropsType> &
