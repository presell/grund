...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: RMG78uV9qS-T/css

import SquareSvgIcon from "./icons/PlasmicIcon__SquareSvg"; // plasmic-import: 4q-6m0GtXA_b/icon
import SquareCheckFilledSvgIcon from "./icons/PlasmicIcon__SquareCheckFilledSvg"; // plasmic-import: 8P2jfiSuIQwi/icon
import SquareMinusSvgIcon from "./icons/PlasmicIcon__SquareMinusSvg"; // plasmic-import: AbLn6Ilu0AWe/icon
