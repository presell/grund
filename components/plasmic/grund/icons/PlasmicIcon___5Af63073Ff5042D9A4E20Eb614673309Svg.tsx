...
export type _5Af63073Ff5042D9A4E20Eb614673309SvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function _5Af63073Ff5042D9A4E20Eb614673309SvgIcon(
  props: _5Af63073Ff5042D9A4E20Eb614673309SvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M35.889 0C37.05 0 38 .982 38 2.182v19.636c0 1.2-.95 2.182-2.111 2.182H2.11C.95 24 0 23.018 0 21.818V2.182C0 .982.95 0 2.111 0H35.89z"
        }
        fill={"#5A31F4"}
      ></path>
...
export default _5Af63073Ff5042D9A4E20Eb614673309SvgIcon;
/* prettier-ignore-end */
