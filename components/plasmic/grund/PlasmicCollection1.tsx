...
import sty from "./PlasmicCollection1.module.css"; // plasmic-import: 6A2rTFIJVRXH/css
...
function PlasmicCollection1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ciMp2)}>
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img___8XlZn)}
              displayHeight={"auto"}
              ...
              loading={"lazy"}
              src={{
                src: "/plasmic/grund/images/productVariety1C2E7Bd9Ac9C4989Bfad811526Dad7E0250X2502XJpgPng.png",
                fullWidth: 387,
                fullHeight: 442,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yw9N)}>
        {renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__qraau)}>
        {renderPlasmicSlot({
          defaultContents: "\u2605\u2605\u2605\u2605\u2605 (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mv6Dn)}>
        {renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__iyTS)}>
        {renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ezxzH)}>
        {renderPlasmicSlot({
      ...
      >
        <div className={classNames(projectcss.all, sty.column__sPlrg)}>
          <div className={classNames(projectcss.all, sty.freeBox__zl2Bk)}>
            {renderPlasmicSlot({
              defaultContents: (
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___7ILTm)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__d2ZLs)}>
              {renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.column__keokK)}>
          <div className={classNames(projectcss.all, sty.freeBox__v6Kk)}>
            {renderPlasmicSlot({
              defaultContents: (
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__rb3Qz)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox___5FzWd)}>
              {renderPlasmicSlot({
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCollection1__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCollection1__ArgsType, ReservedPropsType> &
