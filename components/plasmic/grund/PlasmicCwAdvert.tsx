...
import BodyArticle1 from "../../BodyArticle1"; // plasmic-import: OqN4TgEOJwCD/component
import BodyArticle2 from "../../BodyArticle2"; // plasmic-import: 1jbZUBn3YO-n/component
...
import sty from "./PlasmicCwAdvert.module.css"; // plasmic-import: GrqiAp8CNyZB/css
...
function PlasmicCwAdvert__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.columns__tbr8K)}>
          <div className={classNames(projectcss.all, sty.column__bbCTp)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
          ...
          <div className={classNames(projectcss.all, sty.column__cVmj)}>
            <div
      ...
      >
        ...
        <div className={classNames(projectcss.all, sty.freeBox__usfMi)}>
          <PlasmicImg__
      ...
      >
        <div className={classNames(projectcss.all, sty.columns__m8B8E)}>
          <div
          ...
          >
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cw1Q)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__pIRy)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__nNpq)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__jrCb)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__ktZoE)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                ...
                >
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img___65Y2F)}
                    displayHeight={
                      hasVariant(globalVariants, "screen", "mobileOnly")
                        ? "auto"
                        : "422px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__kzVvw)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox___0CwgI)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__v0B43)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__awpEa)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox___29PhG)}>
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__yhp5A)}>
                <PlasmicLink__
                ...
                <div
                  className={classNames(projectcss.all, sty.freeBox__vk8Xw)}
                />

                <div className={classNames(projectcss.all, sty.freeBox__necgs)}>
                  <div
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__z0Im)}>
              <div className={classNames(projectcss.all, sty.freeBox__le1Ip)}>
                <PlasmicImg__
              ...
              <div className={classNames(projectcss.all, sty.freeBox__s3Zgu)}>
                <PlasmicImg__
              ...
              <div className={classNames(projectcss.all, sty.freeBox__eZbmK)}>
                <PlasmicImg__
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8HGQo)}>
                <PlasmicImg__
            ...
            <React.Fragment>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <PlasmicImg__
                          alt={""}
                          className={classNames(sty.img__pQea2)}
                          displayHeight={"auto"}
                          displayMaxHeight={"none"}
                          displayMaxWidth={"100%"}
                          displayMinHeight={"0"}
                          ...
                          loading={"lazy"}
                          src={{
                            src: "/plasmic/grund/images/image39.webp",
                            fullWidth: 142,
                            fullHeight: 21,
                            aspectRatio: undefined
                          }}
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__jmFln)}
                    >
                      <BodyArticle1
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__heHor)}
                              displayHeight={"auto"}
                              displayMaxHeight={"none"}
                              displayMaxWidth={"100%"}
                              displayMinHeight={"0"}
                              ...
                              loading={"lazy"}
                              src={{
                                src: "/plasmic/grund/images/sidereview3Png.png",
                                fullWidth: 119,
                                fullHeight: 119,
                                aspectRatio: undefined
                              }}
                        ...
                        >
                          <PlasmicImg__
                            alt={""}
                            className={classNames(sty.img___143Qq)}
                            displayHeight={"auto"}
                            displayMaxHeight={"none"}
                            displayMaxWidth={"100%"}
                            displayMinHeight={"0"}
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__uSo)}
                  displayHeight={"30px"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              >
                ...
                >
                  ...
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__eiq97)}
                      displayHeight={"auto"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"100%"}
                      displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__cC04)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img___5XEvj)}
                        displayHeight={"auto"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"100%"}
                        displayMinHeight={"0"}
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__xa8T3)}
                        displayHeight={"19px"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"123%"}
                        displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__jdy65)}>
                  <BodyArticle2
                    className={classNames(
                      "__wab_instance",
                      sty.bodyArticle2___6P4Hh
                    )}
                  />

                  <div
                    className={classNames(projectcss.all, sty.freeBox__kFfwb)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__s9E9B)}
                      displayHeight={"100px"}
                      displayMaxHeight={"none"}
                      ...
                      loading={"lazy"}
                      src={{
                        src: "/plasmic/grund/images/cab4357670Ddf7F8Ce094069Bef14B6APng.png",
                        fullWidth: 119,
                        fullHeight: 119,
                        aspectRatio: undefined
                      }}
                    ...
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__s2GWv)}
                      displayHeight={"auto"}
                      displayMaxHeight={"none"}
                      displayMaxWidth={"100%"}
                      displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__x5ABe)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__iupbr)}
                    displayHeight={"100px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__riUUo)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img___2XOtN)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
                ...
                <div className={classNames(projectcss.all, sty.freeBox__exmMk)}>
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__aSf81)}
                    displayHeight={"100px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__lO8EV)}
                    displayHeight={"auto"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicCwAdvert__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicCwAdvert__ArgsType, ReservedPropsType> &
