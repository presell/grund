...
import sty from "./PlasmicBodyArticle2.module.css"; // plasmic-import: 1jbZUBn3YO-n/css
...
function PlasmicBodyArticle2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__tub2S)}
        component={Link}
        href={(() => {
          try {
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__oiZng)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__uq6K9)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__seOfh)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__eQgwx)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__pOYe)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link___70YFj)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__x8ZP8)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
          ...
          <div className={classNames(projectcss.all, sty.column___41PHr)}>
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img___4O0Mf)}
              displayHeight={
                hasVariant(globalVariants, "screen", "mobileOnly")
                  ? "70%"
                  : "80%"
          ...
          <div className={classNames(projectcss.all, sty.column__kIvx6)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__gpwCx)}
              displayHeight={"auto"}
              displayMaxHeight={"none"}
              displayMaxWidth={"100%"}
              displayMinHeight={"0"}
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__ihFb4)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicBodyArticle2__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicBodyArticle2__ArgsType, ReservedPropsType> &
